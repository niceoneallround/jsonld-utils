...
//
// Lightweight wrapper around the compact - NOTE TURNS OFF EXPANSION BEFORE COMPACT so assumes expanded
//
jsonldUtils.promises.compact = function compact(input, context) {
  'use strict';

  return jsonld.promises.compact(input, context, { expandContext: {}, })
...
// in the future. NOTE Flatten expands the result, when tried to compact
// got a crazy result, FIXME FIXME need to look at more
//
// Assumptions
//  - input has been expanded
//
