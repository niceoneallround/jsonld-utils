...
function findObjectsPromise(inputDoc, type, optionsMap) {
  'use strict';
  ...
  p1 = expandPromise.then(
    function (expanded) { // ok
      console.log('findObjectPromise.expandPromise.then expaned:%j', expanded);
      return expanded;
    },
...
module.exports = {
  ...
  createV: createV,
  findObjectsPromise: findObjectsPromise,
  getArray: getArray,
  getO: getO,
  getV: getV,
  isType: isType
